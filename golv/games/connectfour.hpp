...
class connectfour
{
  ...
  private:
    ...
    std::vector<connectfour::player_type> get_minor_diag(connectfour::ext_state_type const& state,
                                                         size_t row,
                                                         size_t col);

    std::vector<connectfour::player_type> get_major_diag(connectfour::ext_state_type const& state,
                                                         size_t row,
                                                         size_t col);
};

...
#include <golv/algorithms/unordered_table.hpp>
...
auto alphabeta(GameT g, LessT o = no_ordering{}, LookupT l = no_table<GameT>{}) {
  alpha_beta ab(g, o, l);
...
auto alphabeta_with_memory(GameT g, LessT o = std::less<typename GameT::move_type>{}) {
